...
added_files = [
    ...
    (os.path.join(project_root, 'everything_search.py'), '.'),
    (os.path.join(project_root, 'everything_search_prompt.md'), '.'),
    (os.path.join(project_root, 'everything_file_filters.py'), '.'),
    (os.path.join(project_root, 'window_snap.py'), '.'),
]
